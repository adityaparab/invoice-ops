...
from invoiceops_agent.tools.ingestion_schemas import DocumentType, IngestionSource, RawDocument
...
async def read_document(
    ...
    *,
    ...
    return RawDocument(
        cast(DocumentType, content_type), content_hash, request_hash, bytes(data), source
    )
